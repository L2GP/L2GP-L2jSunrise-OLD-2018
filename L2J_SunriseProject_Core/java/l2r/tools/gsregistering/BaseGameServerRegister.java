...
public abstract class BaseGameServerRegister
{
	...
	private static void printHelp(ResourceBundle bundle)
	{
		String[] help =
		{
			 ...
			 * "-u, --unregister <id>|all\t\tRemoves GameServer denoted by <id>, use \"all\" for removing all registered GameServers", "", "Copyright (C) L2J Team 2008-2012.", "Report bugs: http://www.L2GamePlay.com"
			 */
		};

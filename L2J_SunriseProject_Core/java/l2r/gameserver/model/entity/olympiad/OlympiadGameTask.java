...
public final class OlympiadGameTask implements Runnable
{
	...
	// L2GamePlay: this is used only for arena status (standBy or Playing) in ExOlympiadMatchList
	...
	private final boolean startGame()
	{
		try
		{
			...
			// L2GamePlay 3v3 matches should not have buffers
			if (!_game.needBuffers())
			{
				_zone.deleteBuffers();
			}
			...
			// L2GamePlay: better handling olympiad announcements

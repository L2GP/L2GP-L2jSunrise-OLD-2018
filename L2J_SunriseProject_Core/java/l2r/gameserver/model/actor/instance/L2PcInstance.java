...
public final class L2PcInstance extends L2Playable
{
	...
	// L2GamePlay: check if player can crystallize items
	...
	// L2GamePlay: new method for fast target change
	...
	public boolean dismount()
	{
		...
		setPet(null);
		// Notify self and others about speed change
		// L2GamePlay: double broadcast in order to fix visual bugs in inventory
		broadcastUserInfo();
		broadcastPacket(new Ride(this));
		broadcastUserInfo();
		return true;
	...
	// L2GamePlay packet system controlling packets
	...
	private boolean checkUseMagicConditions(L2Skill skill, boolean forceUse, boolean dontMove)
	{
		...
		// L2GamePlay: If target player is flagged cannot obtain good magic unless is forceUse or is friend(Party, Clan, Ally etc)
	...
	public void enterOlympiadObserverMode(Location loc, int id)
	{
		...
		// L2GamePlay: enable fly mode when enter oly observe
		setIsFlying(true);
	...
	public void leaveOlympiadObserverMode()
	{
		...
		// L2GamePlay: disable fly mode when leave oly observe
		setIsFlying(false);
	...
	// L2GamePlay: fix issues with olympiad registered players
	...
	public void onActionRequest()
	{
		...
		// L2GamePlay: remove those checks outside of spawn protection check
		...
		// L2GamePlay: action for events if there is one
	...
	public void checkPlayerSkills()
	{
		for (int id : getSkills().keySet())
		{
			...
			// L2GamePlay: expertise skill must skip level diff and checked all the time
	...
	// ============================================== //
	// Prime Shop Engine By L2GamePlay Team //
	// ============================================== //
	...
	// ============================================== //
	// Donate Engine By L2GamePlay Team //
	// ============================================== //
	...
	// ============================================== //
	// Antibot Engine By L2GamePlay Team //
	// ============================================== //
	...
	// ============================================== //
	// Achievements Engine By L2GamePlay Team //
	// ============================================== //
	...
	// ============================================== //
	// FlagZone Engine By L2GamePlay Team //
	// ============================================== //
	...
	// ============================================== //
	// Event Engine By L2GamePlay Team //
	// ============================================== //
	private final PlayerEventInfo _eventInfo = new PlayerEventInfo(this);
	
	// ============================================== //
	// Antifeed Protection Engine By L2GamePlay Team //
	// ============================================== //
	// For Flag zone
	...
	// Delay Engine By L2GamePlay Team
	...
	// ============================================== //
	// Premium Engine By L2GamePlay Team //
	// ============================================== //
	...
	// ============================================== //
	// Sql Variables Engine By L2GamePlay Team //
	// ============================================== //

...
public abstract class L2Skill implements IChanceSkillTrigger, IIdentifiable
{
	...
	{
		// L2GamePlay: this will prevent debuffs apply on dead characters
		if (effected == null)
		{
			return _emptyEffectSet;
		}
		
		// L2GamePlay: this will prevent some effect apply on dead characters
		...
		if (isDebuff())
		{
			// L2GamePlay cancel can't be resisted retail like
		...
		{
			// L2GamePlay check if we need more checks here
